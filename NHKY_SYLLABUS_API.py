...
class NHKY_SYLLABUS_API:
    def __init__(self, username, password):  # 初始化账号和密码
        self.username = str(username)
        self.password = str(password)

    url_login = 'http://qzjwxt.kjxy.nchu.edu.cn:800/jsxsd/xk/LoginToXk'
    url_syllabus = 'http://qzjwxt.kjxy.nchu.edu.cn:800/jsxsd/xskb/xskb_list.do'
